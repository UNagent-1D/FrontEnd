...
const features = [
  {
    ...
    body: "Unify chat, email, and voice into one operator view.",
  },
  {
    icon: ShieldCheck,
    title: "Role-based access",
    body: "App admins, tenant admins, and operators — each with the right scope.",
  },
  {
    icon: BarChart3,
    title: "Live operations metrics",
    body: "Watch volume, escalations, and resolution times in real time.",
  },
]
    ...
    <div className="grid min-h-screen bg-background md:grid-cols-2">
      ...
      <aside className="relative hidden flex-col justify-between overflow-hidden bg-primary p-10 text-primary-foreground md:flex">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 20%, hsl(var(--primary-foreground) / 0.35), transparent 60%), radial-gradient(circle at 80% 70%, hsl(var(--category-status-active) / 0.4), transparent 55%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative space-y-8">
          <div>
            ...
            <p className="mt-3 max-w-sm text-sm leading-relaxed opacity-80">
              Configure profiles, wire data sources, watch conversations, and
              keep operators in the loop — all from one place.
            </p>
          </div>
      ...
      <section className="flex items-center justify-center px-4 py-10">
        <Card className="w-full max-w-md border-border/60 shadow-sm">
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Sign in to manage your agents and operators.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <button
                              type="button"
                              disabled
                              className="text-xs font-medium text-muted-foreground hover:text-foreground disabled:cursor-not-allowed"
                            >
                              Forgot password?
                            </button>
                          </TooltipTrigger>
